                ...
                <div class="container-fluid">
                    <div class="fade-in">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <s:form class="form-horizontal" action="editDiemSubmitAction" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" readonly="" value="<s:property value="maMH"/>" id="maMH" type="text" name="maMH" placeholder="Mã MH">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="email-input">Học Kỳ</label>
                                        <div class="col-md-9">
                                            <input class="form-control" type="number" id="hocKy" name="hocKy" value="<s:property value="hocKy"/>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="email-input">Điểm Lần 1</label>
                                        <div class="col-md-9">
                                            <input class="form-control" type="number" id="diemLan1" name="diemLan1" value="<s:property value="diemLan1"/>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="email-input">Điểm Lần 2</label>
                                        <div class="col-md-9">
                                            <input class="form-control" type="number" id="diemLan2" name="diemLan2" value="<s:property value="diemLan2"/>">
                                        </div>
                                    </div>
